 ...
 * 网络接口具体实现
 */
class ${StringUtil.lineToHump(page)}RepositoryImpl: I${StringUtil.lineToHump(page)}Repository {

    override fun sync${StringUtil.lineToHump(page)}Data(listener: HttpGroup.OnCommonListener, requestParam: RequestParam) {
